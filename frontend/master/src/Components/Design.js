    ...
    <div className='design'>
        <div className='design__text'>
            <div className='design__titles'>
                <h1 className='design__h1'>new design</h1>
                <h2 className={useScroll(150) ? 'design__h2 active' : 'design__h2'}>There is no other platforms for you as like <b className='design__toch'>....</b></h2>
            </div>
            <p className={useScroll(320) ? 'design__paragraphs active' : 'design__paragraphs'}>
            ...
            <p className={useScroll(450) ? 'design__paragraphs active' : 'design__paragraphs'}>    
